  ...
  return (
    <div className={"w-screen h-screen flex justify-center items-center overflow-hidden relative"}>
      <img src={"/img/background_hero.png"} alt={"logo"}
           className={"w-full h-full top-0 left-0 absolute object-cover bg-hero"}/>
      <img src={"/img/background_light_hero.png"} alt={"bg"}
           className={"w-full h-full top-0 left-0 absolute object-fill bg-hero"}/>
      <img src={"/img/frame_watch.svg"} alt={"frame"}
           className={"w-screen top-[33vh] animation-rotate left-0 absolute opacity-20 object-fill bg-hero"}/>

      <div className={"flex flex-col absolute z-10 top-[10vh]"}>
      ...
      <div className="fixed-container w-[calc(100vw_-_40px)] flex justify-center h-[calc(100vh_-_40px)]">
        ...
        <p
          className={"font-body text-[0.9vw] h-fit w-full mx-[5vw] tracking-tight flex justify-between text-[#FFD700] text-opacity-40 top-[-10px] relative"}>
